...
const RECORDS: CallRecord[] = [
  ...
  },
  {
    ...
    expectedRead: 152_100, classification: { kind: "partial", cause: { kind: "unknown", detail: "unknown (provider did not expose why)" } },
  ...
  },
  {
    ...
    expectedRead: 153_200, classification: { kind: "miss", cause: { kind: "ttl", detail: "5m TTL reached after 7m00s idle" } },
...
test("cachemire ledger and one-line surfaces golden", () => {
  ...
  const lines = [
    ...
    `\u25cd ${renderBreakingLine({ cause: { kind: "model", detail: "model switched claude-opus-4-8 \u2192 gpt-5.6-sol" }, estimatedRewriteTokens: 96_400, targetProvider: "openai-codex", estimatedUsd: 0.12, estimateBasis: "direct" })}`,
