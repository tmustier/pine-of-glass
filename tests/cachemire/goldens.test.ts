...
test("cachemire ledger and one-line surfaces golden", () => {
  ...
  const lines = [
    ...
    `\u25cd ${renderBreakingLine({ cause: { kind: "model", detail: "model switched claude-opus-4-8 \u2192 gpt-5.6-luna" }, estimatedRewriteTokens: 96_400, targetProvider: "openai-codex", estimatedUsd: 0.12, estimateBasis: "direct" })}`,
